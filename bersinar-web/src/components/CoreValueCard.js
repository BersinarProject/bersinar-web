...
export default function CoreValueCard({ className, img, children }) {
    return (
        <div
            ...
            <div className="px-2 py-4 sm:p-4 w-[112px] sm:w-[228px] lg:w-[300px] h-auto flex flex-col sm:flex-row justify-center items-center">
                <img
                    src={img}
                    alt={children}
                    className="w-10 h-10 sm:h-14 lg:h-20 sm:w-14 lg:w-20 mb-3 sm:mb-0 sm:mr-7"
                />
